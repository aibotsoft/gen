...
// NewErrorResponseWithErrorRef instantiates a new ErrorResponseWithErrorRef object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewErrorResponseWithErrorRef() *ErrorResponseWithErrorRef {
	this := ErrorResponseWithErrorRef{}
	return &this
}

// NewErrorResponseWithErrorRefWithDefaults instantiates a new ErrorResponseWithErrorRef object
...
func (v NullableErrorResponseWithErrorRef) Get() *ErrorResponseWithErrorRef {
	return v.value
}

func (v *NullableErrorResponseWithErrorRef) Set(val *ErrorResponseWithErrorRef) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorResponseWithErrorRef) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorResponseWithErrorRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorResponseWithErrorRef(val *ErrorResponseWithErrorRef) *NullableErrorResponseWithErrorRef {
	return &NullableErrorResponseWithErrorRef{value: val, isSet: true}
}
