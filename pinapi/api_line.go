...
func (r apiLineSpecialV1GetRequest) Handicap(handicap int32) apiLineSpecialV1GetRequest {
	r.handicap = &handicap
	return r
}
...
func (r apiLineStraightV1GetRequest) LeagueId(leagueId int32) apiLineStraightV1GetRequest {
	r.leagueId = &leagueId
	return r
}
...
func (r apiLineStraightV1GetRequest) SportId(sportId int32) apiLineStraightV1GetRequest {
	r.sportId = &sportId
	return r
}
...
func (r apiLineStraightV1GetRequest) PeriodNumber(periodNumber int32) apiLineStraightV1GetRequest {
