...
func (r apiBetsGetBetsByTypeV3Request) PageSize(pageSize int32) apiBetsGetBetsByTypeV3Request {
	r.pageSize = &pageSize
	return r
}

func (r apiBetsGetBetsByTypeV3Request) FromRecord(fromRecord int32) apiBetsGetBetsByTypeV3Request {
