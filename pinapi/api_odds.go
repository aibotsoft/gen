...
func (r apiOddsSpecialV1GetRequest) SportId(sportId int32) apiOddsSpecialV1GetRequest {
	r.sportId = &sportId
	return r
}
...
func (r apiOddsSpecialV1GetRequest) LeagueIds(leagueIds []int32) apiOddsSpecialV1GetRequest {
...
func (r apiOddsStraightV1GetRequest) SportId(sportId int32) apiOddsStraightV1GetRequest {
	r.sportId = &sportId
	return r
}

func (r apiOddsStraightV1GetRequest) LeagueIds(leagueIds []int32) apiOddsStraightV1GetRequest {
	r.leagueIds = &leagueIds
	return r
}
