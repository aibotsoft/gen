...
type SpecialLineResponse struct {
	...
	// Special Id.
	SpecialId *int64 `json:"specialId,omitempty" xml:"specialId"`
	// Contestant Id.
	ContestantId *int64 `json:"contestantId,omitempty" xml:"contestantId"`
...
// GetSpecialIdOk returns a tuple with the SpecialId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
// GetContestantIdOk returns a tuple with the ContestantId field value if set, zero value otherwise
// and a boolean to check if the value has been set.
